...
So we must narrow down to an otimal value of 'c' and 'm' such that they have the least corresponding cost in the above 3d graph. We could point to some random value by looking at the graph but we need to solve it through equations.  
